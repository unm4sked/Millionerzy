...
2.Mozesz w kazdym pytaniu uzyc jednego kola ratunkowego
    -50:50    -> nacisnij "5"
    -Telefon do przyjaciela -> nacisnij "T"
    -Glos publicznosci -> nacisnij "P"
...
6.Jesli cos juz wygrasz bedziesz mogl odejsc z hajsem poprzez "ODCHODZE" , bedziesz zapisany w tabeli wtedy
